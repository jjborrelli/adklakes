...
als_physic %>% filter(month(dmy(ADATE)) == 8) %>% 
  ...
  #scale_y_log10() + 
  scale_x_log10() + 
  labs(x = "Log10 Surface Area", y = "Log10 Aug Thermocline Depth")
...
```{r}
altm %>% 
  mutate(date = ymd(Conformed_Date)) %>% 
